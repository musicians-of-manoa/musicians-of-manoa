...
const DJsPage = async ({ searchParams }: CategoryPageProps) => {
  ...
  return (
    <main>
      <Container id="dj-search" className="d-flex justify-content-center py-3">
        <Row>
          <Col>
            <Col className="text-center py-4" style={{ fontFamily: 'Arial' }}>
              <h2>
                <strong>Discover DJs</strong>
              </h2>
            </Col>
          </Col>
        </Row>
